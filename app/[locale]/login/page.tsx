    ...
    <main>
      ...
      <div className="flex items-center justify-center bg-brand-navy px-4 py-16">
        <form onSubmit={handleSubmit} className="w-full max-w-sm rounded-3xl bg-white p-8 shadow-2xl">
          ...
          <p className="mb-6 text-sm text-brand-slate">Sign in to XCEED India.</p>

          <label className="mb-1 block text-xs font-semibold text-brand-charcoal">Email or Username</label>
          <input
            value={identifier}
